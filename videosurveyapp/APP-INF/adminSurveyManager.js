...
function getQuestionType(type){
    var QUESTION_TYPES = {'MC': 'Multiple Choices','PT':'Plain Text', 'YN': 'Yes/No', 'SC': 'Single Choice','V': 'Video'};
...
function viewFile(page, params){
    var hash = params.hash;
    var type = params.type;
    log.info('viewfile {} hash, {} type', hash, type);
    if(hash && type){
